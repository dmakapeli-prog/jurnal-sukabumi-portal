...
export async function generateMetadata({
  ...
  if (!article) {
    return { title: "Artikel Tidak Ditemukan | Jurnal Sukabumi" };
  }

  return {
    title: `${article.title} | Jurnal Sukabumi`,
          ...
          <article className="lg:col-span-8">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-outline-variant">
              ...
              <div className="flex items-center gap-2 text-on-surface-variant">
                ...
                <span className="font-[Roboto] text-[13px]">
            ...
            <div className="mt-10 pt-6 border-t border-outline-variant">
              ...
              <div className="flex flex-wrap gap-2">
                {[article.category, "Sukabumi", "Berita Terkini"].map(
                  (tag) => (
                    <Link
                      key={tag}
                      href="#"
